...
type ModelsInstance<ModelBaseTypes extends {}, ModelCreationTypes extends {}> = InstanceType<new (ModelArguments: ModelConstructor<ModelCreationTypes, {}, {}>) => Models<ModelBaseTypes, ModelCreationTypes>>;
...
export class Models<ModelBaseTypes extends {}, ModelCreationTypes extends {}> {
    ...
    constructor(ModelArguments: ModelConstructor<Models<ModelBaseTypes, ModelCreationTypes>['model'], ModelBaseTypes, ModelCreationTypes>) {
        this.ModelArguments = {
            ...ModelArguments,
            status: false
        };
