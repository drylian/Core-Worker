...
export function InstallerSetupFinish() {
  ...
  <div class="max-w-md bg-slate-700 p-4 m-2 rounded-md shadow-md text-center justify-center">
    ...
    <p class="text-gray-300 mb-4">${i18n.t("installer.FinishMessage")}.</p>
    <form action="/install/setup/finish" method="post" class="text-left">

    <div class="mt-4 flex justify-between">
      <a href="/install/setup/three" class="bg-blue-900 text-white rounded-md hover:bg-blue-700 duration-200"><i class='text-lg px-4 py-2 bx bxs-left-arrow-alt'></i></a>
